...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if ($_POST['type'] == "3") {
        ...
        $key = "";  // Use consistent variable name
        ...
        mysqli_query($con, "UPDATE industry SET industry_name='" . $_POST['industry_name12'] . "' $key WHERE id='" . $_POST['id12'] . "' ");
        // echo "UPDATE industry SET industry_name='".$_POST['industry_name12']."' $key WHERE id='" . $_POST['id12'] . "' ";
        header("Location: Industries");
    ...
    <div id="ebazar-layout" class="theme-blue">
        ...
        <div class="main px-lg-4 px-md-4">
                        ...
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                ...
                                <div class="col-auto d-flex w-sm-100">
                                    <button type="button" class="btn btn-primary btn-set-task w-sm-100" data-bs-toggle="modal" data-bs-target="#expadd"><i class="icofont-plus-circle me-2 fs-6"></i>Add Industry</button>
                                </div>
                            </div>
                        </div>
                    </div> <!-- Row end  -->
                                    ...
                                    <div class="card-body">
                                        <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $a=0;
                                                $result = mysqli_query($con, "SELECT * FROM industry where status = 1 ORDER BY id DESC ");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img class="avatar rounded" src="<?php if (!empty($row['image'])) {
                                                                                                    echo "assets/images/industry/" . $row['image'];
                                                                                                } else { ?>assets/images/xs/avatar1.svg<?php } ?>" alt="">
                                                            <span class="fw-bold ms-1"><?php echo $row['industry_name']; ?></span>
                                                        </td>
                                                        <td>
                                                            <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                                <button type="button" class="btn btn-outline-secondary edit_industry" data-bs-toggle="modal" data-bs-target="#expedit" data-industry-id="<?php echo $row['id'] ?>">
                ...
                <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title  fw-bold" id="expaddLabel">Add Industry</h5>
            ...
            <div class="modal fade" id="expedit" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
                    <div class="modal-content" id="edit_industry">
